  ...
  if (cart.length === 0) {
    return (
      <main className="flex-1 flex flex-col items-center justify-center py-20 px-4">
        ...
        <h1 className="text-3xl font-black text-slate-900 dark:text-white mb-2">Your cart is empty</h1>
      ...
      <div className="flex flex-col lg:flex-row max-w-[1200px] flex-1 gap-8">
        ...
        <div className="flex-1 flex flex-col gap-6">
          <div className="flex items-end justify-between">
            <div className="flex flex-col gap-2">
              ...
              <h1 className="text-slate-900 dark:text-slate-100 text-3xl font-black leading-tight tracking-tight">Your Shopping Cart</h1>
              <p className="text-slate-500 dark:text-slate-400">You have {cart.length} items in your cart</p>
            </div>
        ...
        <div className="w-full lg:w-[380px] flex flex-col gap-6">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
            <h2 className="text-slate-900 dark:text-slate-100 text-xl font-bold mb-6">Order Summary</h2>
            <div className="flex flex-col gap-4 mb-6">
              ...
              <div className="flex justify-between items-center text-slate-600 dark:text-slate-400">
                ...
                <span className="text-green-600 dark:text-green-400 font-medium uppercase text-xs tracking-wider">Free</span>
              </div>
              <div className="flex justify-between items-center text-slate-600 dark:text-slate-400">
            ...
            <div className="mb-8">
              <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2 uppercase tracking-wide">Promo Code</label>
              <div className="flex gap-2">
                <input className="flex-1 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-slate-100 focus:ring-primary focus:border-primary text-sm px-4 outline-none" placeholder="Enter code" type="text" />
                <button className="px-4 py-2 bg-slate-900 dark:bg-slate-700 text-white rounded-lg text-sm font-bold hover:bg-slate-800 transition-colors">Apply</button>
              </div>
            </div>
            <Link to="/checkout" className="w-full bg-primary hover:bg-blue-600 text-white py-4 rounded-xl font-black text-lg shadow-lg shadow-primary/20 transition-all flex items-center justify-center gap-2 group">
              Proceed to Checkout <ArrowRight size={20} className="transition-transform group-hover:translate-x-1" />
            </Link>
            ...
            <div className="mt-6 flex flex-col gap-3">
              <div className="flex items-center gap-3 text-slate-500 text-xs">
                <ShieldCheck size={16} className="text-slate-400" /> <span>Secure encrypted checkout</span>
              </div>
              <div className="flex items-center gap-3 text-slate-500 text-xs">
                <Truck size={16} className="text-slate-400" /> <span>Fast delivery across all regions</span>
              </div>
            </div>
          </div>
        </div>
